% localHypothesisRefinement.m 
% 
% author: Sebastian Lin
% date:   13-11-2016 (dd-mm-yyyy)
% 
% brief: Inspect all hypotheses generated by one segment and choose the
% best hypothesis that could represent the area under inspection 

%% ( 0 ) Compute normalized ratio 
% Compute the nomralized ratio of each hypothesis area covered by the
% initiating segment 
