...
{ 
  ...
  * -------------------------------------------------------------- */  
  ...
  {    
    ...
    unsigned int height  ( N[0] ); // matlab gives first height
    unsigned int width ( N[1] ); // matlab gives then width
  ...
  * -------------------------------------------------------------- */      
  ...
  else
  {
    ...
    if ( b_computeColorOutput )
    {
      ...
      for ( unsigned int x = 0; x < width; x++)
      {
        unsigned int rowOffset ( x*height );
        for ( unsigned int y = 0; y < height; y++)
        {
      ...
      /* GREEN channel*/
      unsigned int channelOffsetG ( width * height );
      for ( unsigned int x = 0; x < width; x++)
      {
        unsigned int rowOffset ( x*height );
          for ( unsigned int y = 0; y < height; y++)
      ...
      /* BLUE channel*/
      unsigned int channelOffsetB ( 2 * width * height );
      for ( unsigned int x = 0; x < width; x++)
      {
        unsigned int rowOffset ( x*height );
          for ( unsigned int y = 0; y < height; y++)
